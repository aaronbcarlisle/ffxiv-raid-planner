 ...
 * Extracted from AdminDashboard.tsx to live under the admin layout.
 * Auth guard is now handled by AdminLayout.
 */
...
import { Eye, ChevronUp, ChevronDown, ChevronsUpDown, Search } from 'lucide-react';
...
const logger = baseLogger.scope('admin-statics');
  ...
  return (
    <div className="max-w-7xl mx-auto w-full">
      ...
      <div className="flex items-center justify-between mb-6 w-full">
        <div>
          <h1 className="text-3xl font-display text-status-warning">All Statics</h1>
          ...
          {totalPages > 1 && (
            <div className="flex items-center justify-between mt-4">
              ...
              <div className="flex gap-2">
                {/* design-system-ignore: Pagination buttons with custom compact styling */}
                <button
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="relative bg-surface-card border border-border-default rounded-lg shadow-xl max-w-md w-full mx-4">
              ...
              {viewAsMembersLoading ? (
                ...
                <div className="space-y-2">
                  {viewAsMembers.map((member) => (
                    // design-system-ignore: Interactive member list item in modal
                    <button
                      key={member.id}
            ...
            <div className="p-4 border-t border-border-subtle flex justify-end">
              {/* design-system-ignore: Simple cancel button in modal footer */}
              <button
                onClick={() => setViewAsGroup(null)}
