...
export function InviteAccept() {
  ...
  if (error || !preview) {
    return (
      <div className="min-h-screen bg-bg-primary flex items-center justify-center p-4">
        <div className="bg-bg-card border border-white/10 rounded-lg p-8 max-w-md w-full text-center">
  ...
  return (
    <div className="min-h-screen bg-bg-primary flex items-center justify-center p-4">
      <div className="bg-bg-card border border-white/10 rounded-lg p-8 max-w-md w-full">
        {/* Header */}
        ...
        {/* Static Info */}
        <div className="bg-bg-primary border border-white/10 rounded-lg p-4 mb-6">
        ...
        {/* Status Messages */}
        {!preview.isValid && (
          <div className="bg-yellow-500/10 border border-yellow-500/30 rounded p-3 mb-4 text-sm text-yellow-400">
            This invitation is no longer valid. It may have expired or reached its usage limit.
          </div>
        )}

        {preview.alreadyMember && (
          <div className="bg-blue-500/10 border border-blue-500/30 rounded p-3 mb-4 text-sm text-blue-400">
        ...
        {!isAuthenticated ? (
          <div className="space-y-4">
            ...
            <button
              onClick={handleLogin}
              className="w-full bg-[#5865F2] text-white px-6 py-3 rounded font-medium hover:bg-[#4752C4] flex items-center justify-center gap-2"
            >
          ...
          <div className="space-y-3">
            <button
              ...
              className="w-full bg-accent text-bg-primary px-6 py-3 rounded font-medium hover:bg-accent-bright disabled:opacity-50"
            >
