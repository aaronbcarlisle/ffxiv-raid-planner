...
export function AddSlotCard({ onAdd }: AddSlotCardProps) {
  return (
    <button
      type="button"
      onClick={onAdd}
      className="w-full bg-surface-card border-2 border-dashed border-border-default rounded-lg p-4 transition-all hover:border-solid hover:border-accent hover:bg-surface-interactive group flex items-center justify-center gap-2 min-h-[76px]"
    >
