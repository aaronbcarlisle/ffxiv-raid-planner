            ...
            {!reverseLayout && (
              <div className="p-2 border-b border-border-default">
                <input
                  ...
                  className="w-full bg-surface-elevated border border-border-default rounded px-3 py-2.5 sm:py-1.5 text-base sm:text-sm text-text-primary placeholder:text-text-muted focus-visible:border-accent focus:outline-none"
