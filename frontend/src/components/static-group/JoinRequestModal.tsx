...
export function JoinRequestModal({ isOpen, onClose, shareCode, staticName }: JoinRequestModalProps) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (jobInterest) payload.jobInterest = jobInterest;
    ...
    >
      <div className="space-y-4">
        <p className="text-sm text-text-secondary">
          ...
          role you want to play and when you&apos;re usually available.
        </p>
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div>
            <Label htmlFor="join-job">Job Interest</Label>
            <Select
              value={jobInterest}
              onChange={setJobInterest}
              options={JOB_OPTIONS}
