 ...
 * MyStaticsPanel
 *
 * The user's static groups browser — grid/list of statics, sort/view controls,
 * create wizard, per-static context menu and delete confirmation. Extracted
 * from the Dashboard page so it can render both at `/dashboard` (full page) and
 * inside the Player Hub "My Statics" tab. Behavior is identical in both hosts;
 * the host is responsible for auth gating.
 */
...
import { ContextMenu, Select, Input, Label, Modal, StaticGridSkeleton, StaticListSkeleton, ErrorMessage } from '../ui';
...
export function MyStaticsPanel() {
