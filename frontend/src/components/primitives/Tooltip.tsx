      ...
      <TooltipPrimitive.Root>
        ...
        <TooltipPrimitive.Portal>
          <TooltipPrimitive.Content
            ...
            className="z-50 rounded-md bg-surface-raised px-3 py-2 text-sm text-text-primary shadow-xl border border-border-default animate-in fade-in-0 zoom-in-95 data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95"
          >
            {content}
