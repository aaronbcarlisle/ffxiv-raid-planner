...
export function Modal({ isOpen, onClose, title, children }: ModalProps) {
  ...
  return (
    <dialog
      ...
      className="bg-transparent p-0 overflow-visible backdrop:bg-black/70 backdrop:backdrop-blur-sm open:flex open:items-center open:justify-center open:fixed open:inset-0 open:w-full open:h-full open:max-w-none open:max-h-none"
    >
