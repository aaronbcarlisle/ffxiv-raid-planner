  ...
  return (
    <div className="relative">
      <select
        ...
        className="appearance-none bg-bg-secondary border border-border-default rounded-md px-3 py-2 pr-8 text-sm font-medium text-text-primary cursor-pointer hover:border-accent focus:border-accent focus:outline-none"
