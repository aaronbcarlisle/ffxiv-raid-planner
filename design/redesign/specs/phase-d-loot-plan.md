...
| **D14** | Elsewhere, shortcuts, write-backs | R-40 `FairnessSummary` → Home (drop the `Loot.tsx:396-404` mount); R-42's shortcut set with **shell-aware** help/palette groups (§5); §9 `v2-roster-hide-subs`; **write-backs**: D-23, D-27, D-38, D-39, D-40, D-42 (**name D13's two deltas** — mobile collapse deferred to Phase P, "BiS Progress" tile relabelled "Avg BiS progress"; #271), D-43, D-54, D-72, D-37 — and D-18 explicitly **left open** with R-41's blocker restated | Closes the Phase-C closeout's last DoD item |
